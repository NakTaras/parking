...
@Component
public class GetParkingListToGetReservationCommand implements Command {
    ...
    public void execute(Update update) {
        ...
        parkingList.forEach(parking -> keyboard.add(Collections.singletonList(
                InlineKeyboardButton.builder()
                        ...
                        .callbackData("chooseDate_" + parking.getId())
                        .build())));
        ...
        MessageSenderUtil.sendMessage("Оберіть паркінг по якому хочете отримати список бронювань",
                currentChatID,
